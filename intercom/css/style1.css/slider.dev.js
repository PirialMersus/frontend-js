...
$.fn.slider = function (options) {
  ...
  var $selector = this;
  var $slidesRow = $(".sliderContainer .slidesRow");
  var $arrowLeft = $(".sliderContainer .arrows.left");
  var $arrowRight = $(".sliderContainer .arrows.right");
  var activeSlideCounter = 0;
  var offset = 0;
  var windowWidth = $(".sliderContainer").width(); // console.log("window sizes", windowWidth);

  var slides = $(".sliderContainer .slidesRow .slide").length;
  ...
  function slidesCopyingAtTheBeginning(zeroActiveSlideCounter, zeroSlideCount, zeroTempCounter) {
    ...
    for (var i = 0; i < slides; i++) {
      sliderItem.eq(sliderItem.length - (i + 1)).clone().prependTo($(".slidesRow"));
    }

    $slidesRow.css("width", windowWidth * $(".sliderContainer .slidesRow .slide").length + 100 + "px");
    setTimeout(function () {
  ...
  function navigationController(slideCount) {
    ...
    $('.switches[data_nav="' + (slideCount % slides + 1) + '"]').addClass("active");
  }
  ...
  window.addEventListener("resize", function () {
    ...
    windowWidth = $(".sliderContainer").width(); // $slidesRow.css('width', (slides * windowWidth + 100 + offset) + 'px');
  ...
  document.querySelector(".sliderContainer").addEventListener("touchstart", function (e) {
